...
//     }
    ...
    int c=c1-a;
    int d=d1-a;
    if(a!=b and b!=c and c!=d and (a+b+c+d==r1+r2) and (a+b+c+d==c1+c2) and (a+b+c+d==d1+d2) and (a>=1 and a<=9) and (b>=1 and b<=9) and (c>=1 and c<=9) and (d>=1 and d<=9) and a!=c and a!=d and b!=d  ){
        cout<<a<<" "<<b<<endl;
        cout<<c<<" "<<d<<endl;
    }
    else{
